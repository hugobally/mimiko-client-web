  ...
  <div class="menu">
    <div class="menu-buttons">
      ...
      <div
        ...
        class="menu-item menu-button noselect"
        :class="{ 'highlighted-button': currentPanel === '#settings' }"
      >
        <svg
          width="30"
          height="30"
